...
public class OptionsLayoutController extends Dialog<Void> implements Initializable
{
    ...
    public OptionsLayoutController() throws IOException
    {
        ...
        mButtonOK = new ButtonType("Apply", ButtonData.APPLY);
        ButtonType buttonCancel = new ButtonType("Close", ButtonData.CANCEL_CLOSE);
        ...
        buttonOK.addEventFilter(ActionEvent.ACTION, actionEvent -> validateApply(actionEvent));
    }
    ...
    private void validateApply(ActionEvent event)
    {
        int textSize;
        try
        {
            ...
            else
            {
                ...
                OptionsData.storePreferences(getClass());
            }
            event.consume();
